...
RootModule = 'VMWare-Stig.psm1'

# Version number of this module.
ModuleVersion = '1.0.0.0'

# ID used to uniquely identify this module
GUID = 'a132f6a5-8f96-4942-be25-b213ee7e4af6'

# Author of this module
Author = 'Coby Caldwell'

# Company or vendor of this module
CompanyName = ''

# Copyright statement for this module
Copyright = '(c) 2017 Coby Caldwell. All rights reserved.'

# Description of the functionality provided by this module
Description = 'The VMWare-Stig module provides a standardized scanning engine for auditing STIG compliance against VMWare products.
This module also includes some logic for creating the required scan files by extracting the rules from a Manual XXCDF file.'
...
RequiredModules = @(
    @{ModuleName = 'Convert-ESXSTIGToPOSH'},
    @{ModuleName = 'Convert-VMSTIGToPOSH'}
)
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'STIG','PowerStig','VMWare','PowerCLI'

        # A URL to the license for this module.
        #LicenseUri = 'https://github.com/Microsoft/PowerStig/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/clcaldwell/VMWare-Stig'
